...
Run through this before handing the lab to students. The deploy (`rodeo deploy`) takes 1-2.5 hours on nested KVM — leave time for this checklist on top.
...
- Exercise 6 (Rancher-provisioned K3s cluster) takes 5-10 minutes of actual wait time inside the exercise — plan for it.
